...
class Solver():
    ...
    def main(self):
        ...
        if self.prior_params["name"] == "Fourier":
...
if __name__ == "__main__":
    ...
    "/Users/lat/Desktop/Code/pinns-experiments/schrodinger_equation/experiment_configs/TDSE_one_level_AC/config_msffn_w_prior.yaml"
